...
* Coordinate values are provided inside the bounds and in the unit of the
  [Coordinate Reference System](https://docs.fieldtwin.com/design/dashboard/#map-settings)
...
* The bore path is empty by default, it can be set or imported from FieldTwin Design,
  or generated with the [Well Assist integration](https://docs.fieldtwin.com/integrations/wellassist/)
...
[docs link](https://docs.fieldtwin.com/design/dashboard/#links)
...
[docs link](https://docs.fieldtwin.com/design/Releasenotes/#smart-models)
