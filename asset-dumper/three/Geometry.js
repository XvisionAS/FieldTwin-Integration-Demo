...
function copyColorsArray(array, colors) {
  let offset = 0
...
function copyVector2sArray(array, vectors) {
  let offset = 0
...
function copyVector3sArray(array, vectors) {
  let offset = 0
...
Geometry.prototype = Object.assign(Object.create(EventDispatcher.prototype), {
  ...
  toBufferGeometry: function () {
    ...
    if (geometry.normals.length > 0) {
      ...
      copyVector3sArray(normals, geometry.normals)
    ...
    if (geometry.uvs.length > 0) {
      ...
      copyVector2sArray(uvs, geometry.uvs)
    ...
    if (geometry.uvs2.length > 0) {
      ...
      copyVector2sArray(uvs2, geometry.uvs2)
...
Geometry.createBufferGeometryFromObject = function (object) {
  ...
  if (object.isPoints || object.isLine) {
    ...
    copyColorsArray(colors.array, geometry.colors)
